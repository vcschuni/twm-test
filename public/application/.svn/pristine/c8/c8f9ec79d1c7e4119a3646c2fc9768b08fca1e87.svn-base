    ...
    $.each(
      ...
      function (index, location) {
        if (TLIDS.includes(location.NETWORK_SEGMENT_ID)) {
          ...
          var infoComment;
          var tlidObject = app.plugins.CVRestrictionFinder.tlidSegments.find(
            (obj) =>
              obj.properties.TRANSPORT_LINE_ID === location.NETWORK_SEGMENT_ID
          );
